...
### スターターキット (`starter-kit/`) — 新メンバーはここから

| ファイル | 内容 |
|---------|------|
| [README.md](starter-kit/README.md) | セットアップ全体像（30分で完了） |
| [prerequisites.md](starter-kit/prerequisites.md) | 前提条件の確認（Node.js, Python, Git） |
| [claude-code-setup.md](starter-kit/claude-code-setup.md) | Claude Code のインストールと初期設定 |
| [openclaw-setup.md](starter-kit/openclaw-setup.md) | OpenClaw Gateway の導入・エージェント設定 |
| [paperclip-setup.md](starter-kit/paperclip-setup.md) | Paperclip タスク管理の導入 |
| [discord-setup.md](starter-kit/discord-setup.md) | Discord Bot の作成と接続（ハマりポイント付き） |
| [verification.md](starter-kit/verification.md) | 動作確認チェックリスト |
| [troubleshooting.md](starter-kit/troubleshooting.md) | つまずいたときの対処法 |
| [day-one-tasks.md](starter-kit/day-one-tasks.md) | 初日にやるべきこと |
...
### Claude Code活用法 (`claude-code/`)

| ファイル | 内容 |
|---------|------|
| [claude-md-design.md](claude-code/claude-md-design.md) | CLAUDE.mdの設計パターン（チームルールの定義方法） |
| [effective-prompting.md](claude-code/effective-prompting.md) | 効果的な指示の出し方（5要素・信頼度ベース） |
| [team-workflow.md](claude-code/team-workflow.md) | チームでのClaude Codeワークフロー設計 |

### 実用スキル (`skills/`)

| ファイル | 内容 |
|---------|------|
| [practical-skills-catalog.md](skills/practical-skills-catalog.md) | 実際に使えたスキルカタログ（Tier別） |
| [creating-custom-skills.md](skills/creating-custom-skills.md) | カスタムスキルの作り方（設計原則・よくある失敗） |
